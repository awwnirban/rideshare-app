...
contract Main {
  ...
  function finalizeTrip(address _user) public payable {
      require (driverTable[_user].userConfirmation == true, "Specific failure reason1");
      require (driverTable[_user].driverConfirmation == true, "Specific failure reason2");
      require (address(this).balance >= driverTable[_user].amount, "Specific failure reason3");
